...
class PreviewCollectionViewLayout: UICollectionViewFlowLayout {
        ...
        if let collectionView = collectionView,
            ...
            for s in 0 ..< numberOfSections {
                ...
                for i in 0 ..< collectionView.numberOfItems(inSection: s){
                    ...
                    origin.y = attributes.frame.maxY + sectionInset.top
                    maxX = max(maxX, attributes.frame.maxX + sectionInset.right)
                }
                origin.x = maxX
            }
    ...
    // TODO This breaks for variable section lengths
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        return layoutAttributes[collectionView!.numberOfItems(inSection: indexPath.section)*indexPath.section + indexPath.item]
    }
